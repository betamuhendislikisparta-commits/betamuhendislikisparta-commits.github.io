            ...
            <section>
                ...
                <div className="container">
                    ...
                    <div className="col-xxl-6 col-lg-7">
                        <h2 className="cs_fs_48 cs_semibold cs_mb_22">İletişim Bilgileri</h2>
                        <p className="cs_mb_30">Beta Mühendislik olarak ısı pompası, doğalgaz kombi, kat kaloriferi, petek ve tesisat sistemlerinde uzman çözümler sunuyoruz. Sizinle iletişim kurmaktan memnuniyet duyarız.</p>
                        <div className="row cs_gap_y_30 cs_row_gap_30">
                        <ContactCard
                            img="/assets/img/icons/contact_icon_1.svg"
                            Title="Adresimiz"
                            Content="Pirimehmet Mah. 118 Cumhuriyet Cad. <br>No 72 Isparta, 32100"
                        >
                        </ContactCard>
                        <ContactCard
                            img="/assets/img/icons/contact_icon_2.svg"
                            Title="Telefon Numarası"
                            Content="+90 532 629 90 32"
                        >
                        </ContactCard>
                        <ContactCard
                            img="/assets/img/icons/contact_icon_3.svg"
                            Title="E-posta Adresi"
                            Content="beta.muhendislik.isparta@gmail.com"
                        >
                        </ContactCard>
                        <ContactCard
                            img="/assets/img/icons/contact_icon_4.svg"
                            Title="Çalışma Saatleri"
                            Content="Çalışma Saatleri: <br>08:00-22:00"
                        >
                        </ContactCard>                        
                        </div>
                        <div className="cs_height_35 cs_height_lg_35"></div>
                        <h3 className="cs_fs_24 cs_semibold cs_mb_10">Sosyal Medyada Takip Edin:</h3>
                        <p className="cs_mb_20">Beta Mühendislik'in güncel haberlerini ve hizmetlerini takip edin</p>
                ...
                <div className="cs_map">
                    <iframe id="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3128.625284882194!2d30.548063976215816!3d37.76282597202327!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14c7075d2a123b6b%3A0x6c9c8f0b5ef8a2f!2sPirimehmet%20Mahallesi%2C%20118.%20Sk.%2C%2032100%20Isparta%20Merkez%2FIsparta%2C%20T%C3%BCrkiye!5e0!3m2!1str!2str!4v1699999999999!5m2!1str!2str" ></iframe>
                </div>
