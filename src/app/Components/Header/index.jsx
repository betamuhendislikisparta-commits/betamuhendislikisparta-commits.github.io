  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (currentScrollPos === 0) {
        setIsSticky('cs-gescout_show'); // At top - always show
      } else if (currentScrollPos > prevScrollPos) {
        setIsSticky('cs-gescout_sticky'); // Scrolling down - hide
      } else {
        setIsSticky('cs-gescout_show cs-gescout_sticky'); // Scrolling up - show
      }
          ...
          <div className="cs_top_header_in">
            <div className="cs_top_header_left">
              <ul className="cs_top_nav d-flex flex-wrap align-items-center cs_fs_12 text-white m-0 p-0">
                <li>
                Beta Mühendislik - Çalışma Saatleri 08:00-22:00
                </li>
              </ul>
            </div>
