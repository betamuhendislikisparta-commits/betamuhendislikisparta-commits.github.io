...
const ServiceDetails = ({ serviceData }) => {
    ...
    const ServiceCategory = [
        {title:'Isı Pompası Kurulumu', link:'/service/isi-pompasi'},
        {title:'Doğalgaz Kombi Montajı', link:'/service/dogalgaz-kombi'},
        {title:'Petek ve Tesisat Sistemleri', link:'/service/petek-tesisat'},
        {title:'Yangın Tesisatı', link:'/service/yangin-tesisati'}
      ];  
            ...
            <div className="container">
                ...
                <div className="col-lg-8">
                    ...
                    <div className="cs_service_details">
                        <Image src={serviceData?.mainImage || "/assets/img/service_details_1.jpg"} alt="img" width={746} height={427}   /> 
                        <h2 className="cs_fs_48 cs_mb_20">{serviceData?.title || "Hizmet Detayları"}</h2>
                        <p className="cs_mb_25">{serviceData?.description || "Hizmet açıklaması burada yer alacaktır."} <br/><br/>{serviceData?.content || ""}</p>
                        <h3 className="cs_fs_30 cs_mb_15">{serviceData?.subtitle || "Beta Mühendislik Avantajı"}</h3>
                        <p className="cs_mb_25">{serviceData?.additionalContent || "Ek içerik burada yer alacaktır."}</p>
                        <div className="row">
                        ...
                        <p className="cs_mb_25">Enerji değerlendirmesi, eski ünite kaldırma, yeni ünite kurulumu ve enerji verimliliği optimizasyonu. İleri tanı hizmetleri ile sisteminizde büyük sorunlar haline gelmeden önce sorunları tespit edip çözüyoruz.</p>
                        <h3 className="cs_fs_30 cs_mb_15">Isıtma ve Soğutma Sistemleri Hizmetleri</h3>
                        <p className="cs_mb_25">Kapsamlı sistem taraması, arıza tespiti, detaylı rapor ve önerilen çözümler. Sisteminizin maksimum konfor ve verimlilik için optimal ayarlarda çalışmasını sağlayan hassas kalibrasyon hizmetleri.</p>
                        ...
                        <h3 className="cs_fs_30 cs_mb_15">Size özveri ve sevgiyle hizmet veriyoruz</h3>
                        <p className="cs_mb_25">Sistem temizlik hizmetleri ile sisteminizden kir, toz ve kalıntıları temizleyerek hava kalitesini ve sistem verimliliğini artırıyoruz.</p>
                ...
                <div className="col-lg-4">
                    ...
                    <div className="cs_sidebar_widget cs_color_1">
                        ...
                        <input type="text" placeholder="Anahtar Kelime Girin" className="cs_search_input" />
                    ...
                    <div className="cs_sidebar_widget">
                        <h2 className="cs_sidebar_widget_heading cs_fs_24 cs_semibold">Kategoriler</h2>
                    ...
                    <div className="cs_sidebar_widget">
                        <h2 className="cs_sidebar_widget_heading cs_fs_24 cs_semibold">İndir</h2>
                        <div>
