            ...
            <div className="container">
              <div className="cs_footer_top_in">
                ...
                <div className="cs_footer_contact_card">
                  ...
                  <div>
                    <p className="cs_white_color cs_fs_14 mb-0">Hizmetlerimiz İçin Arayın</p>
                    <h3 className="mb-0 cs_fs_24 cs_semibold cs_white_color">+90 532 629 90 32</h3>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="cs_footer_row cs_type_1">
                <div className="cs_footer_col">
                  <div className="cs_footer_widget">
                    <h2 className="cs_footer_widget_title cs_fs_24 cs_semibold cs_white_color cs_mb_10">Hizmetlerimiz</h2>
                    ...
                    <ul className="cs_footer_menu_2">
                      <li><Link href="/service/isi-pompasi">Isı Pompası Kurulumu</Link></li>
                      <li><Link href="/service/dogalgaz-kombi">Doğalgaz Kombi Montajı</Link></li>
                      <li><Link href="/service/petek-tesisat">Petek ve Tesisat Sistemleri</Link></li>
                      <li><Link href="/service/yangin-tesisati">Yangın Tesisatı</Link></li>
                      <li><Link href="/service">Tüm Hizmetler</Link></li>
                    </ul>
                  </div>
                </div>
                <div className="cs_footer_col">
                  <div className="cs_footer_widget">
                    <h2 className="cs_footer_widget_title cs_fs_24 cs_semibold cs_white_color cs_mb_10">Çalışma Saatleri:</h2>
                    <div className="cs_footer_widget_seperator">
                      <span className="cs_accent_bg"></span>
                      <span className="cs_white_bg"></span>
                      <span className="cs_white_bg"></span>
                ...
                <div className="cs_footer_col">
                  <div className="cs_footer_widget">
                    <h2 className="cs_footer_widget_title cs_fs_24 cs_semibold cs_white_color cs_mb_10">Hızlı Bağlantılar</h2>
                    <div className="cs_footer_widget_seperator">
                      <span className="cs_accent_bg"></span>
                      <span className="cs_white_bg"></span>
                      <span className="cs_white_bg"></span>
                ...
                <div className="cs_footer_col">
                  <div className="cs_footer_widget">
                    <h2 className="cs_footer_widget_title cs_fs_24 cs_semibold cs_white_color cs_mb_10">İletişim Bilgileri</h2>
                    <div className="cs_footer_widget_seperator">
                      <span className="cs_accent_bg"></span>
                      <span className="cs_white_bg"></span>
                      <span className="cs_white_bg"></span>
                    </div>
                    <div className="cs_white_color">
                      <p className="cs_mb_10">
                        <strong>Adres:</strong><br/>
                        Pirimehmet Mah. 118 Cumhuriyet Cad.<br/>
                        No 72 Isparta, 32100
                      </p>
                      <p className="cs_mb_10">
                        <strong>E-posta:</strong><br/>
                        beta.muhendislik.isparta@gmail.com
                      </p>
                      <p className="cs_mb_10">
          ...
          <div className="cs_footer_bottom cs_accent_bg cs_white_color">
            <div className="container">
              <div className="cs_footer_bottom_in">
                <div className="cs_footer_copyright">Beta Mühendislik © {new Date().getFullYear()} Tüm Hakları Saklıdır</div>
                <ul className="cs_footer_menu cs_mp_0">
                  <li><Link href="/contact">İletişim</Link></li>
                  <li><Link href="/service">Hizmetlerimiz</Link></li>
                </ul>
              </div>
            </div>
          </div>
